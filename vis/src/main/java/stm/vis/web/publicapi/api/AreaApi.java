...
public interface AreaApi {
	...
	@ApiOperation(value = "", notes = "Upload area message to VIS from other services i.e. Route Check service as an informational message", response = Void.class, tags = {
			"Area", })
	...
	@RequestMapping(value = "/area", produces = { "application/json" }, consumes = {
			"text/xml" }, method = RequestMethod.POST)
	ResponseEntity<Void> uploadArea(HttpServletRequest request,
