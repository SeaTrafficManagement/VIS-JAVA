...
public class MultiPointType2
    extends AbstractGeometricAggregateType
{

    protected List<PointPropertyType2> pointMember;
     ...
     * 
     */
    public List<PointPropertyType2> getPointMember() {
        if (pointMember == null) {
            pointMember = new ArrayList<PointPropertyType2>();
        }
